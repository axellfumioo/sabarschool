...
<html lang="id">
      ...
      <body class="landing-page">
            <div class="page-wrapper">
                  <header class="header text-center" style="border-top: 5px solid #696cff">
                        <div class="container">
                              <div class="branding">
                                    <h1 class="logo">
                                          <span aria-hidden="true" class="icon_documents_alt icon" style="color:#696cff"></span>
                                          <span class="text-bold"> Dokumentasi</span>
                                    </h1>
                              </div>
                              <div class="tagline">
                  ...
                  <section class="cards-section text-center">
                        <div class="container">
                              ...
                              <div class="intro">
                                    <p>Selamat Datang di {{ $app->name_app }} Dokumentasi. Silakan temukan informasi yang anda butuhkan di sini.</p>
                                    <div class="cta-container">
                                          <a class="btn btn-primary btn-cta" style="background-color:#696cff;" href="/docs/v1/start" target="_blank">
                                                <i class="fas fa-book-open"></i>Baca Dokumentasi
                                          </a>
                                    </div>
                              </div>
                              <div id="cards-wrapper" class="cards-wrapper row">
                                    <div class="item item-green col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Bagaimana cara melakukan registrasi?</p>
                                                <a class="link" href="/docs/v1/start#pendahuluan"><span>
                                                      </span>
                                                </a>
                                          </div>
                                    </div>
                                    <div class="item item-purple col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Bagaimana cara melihat materi? Bagaimana cara mengakses voice materi?</p>
                                                <a class="link" href="/docs/v1/start#materi">
                                                      <span></span>
                                                </a>
                                          </div>
                                    </div>
                                    <div class="item item-pink item-2 col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Bagaimana cara mengakses quiz? Bagaimana cara melihat nilai quiz?</p>
                                                <a class="link" href="/docs/v1/start#quiz">
                                                      <span></span>
                                                </a>
                                          </div>
                                    </div>
                                    <div class="item item-primary col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Bagaimana cara menambahkan thread? Bagaimana cara menambahkan komentar?</p>
                                                <a class="link" href="/docs/v1/start#forum">
                                                      <span></span>
                                                </a>
                                          </div>
                                    </div>
                                    <div class="item item-blue col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Bagaimana cara mengganti username? Bagaimana cara mengganti password?</p>
                                                <a class="link" href="/docs/v1/start#pengaturan">
                                                      <span></span>
                                                </a>
                                          </div>
                                    </div>
                                    <div class="item item-orange col-lg-4 col-6">
                                          <div class="item-inner">
                                                ...
                                                <p class="intro">Apa itu SABar School? Bagaimana cara menggunakannya?</p>
                                                <a class="link" href="/docs/v1/start#about">
                                                      <span></span>
                                                </a>
                                          </div>
                                    </div>
            ...
            <footer class="footer text-center">
                  <div class="container">
                        <small class="copyright">Copyright&nbsp;<script>document.write((new Date).getFullYear())</script>&nbsp;<a href="/" class="text-decoration-none" style="color: #696cff; font-weight:bold">{{ $app->name_app }}.</a>&nbsp;All rights reserved</small>
                  </div>
            </footer>
