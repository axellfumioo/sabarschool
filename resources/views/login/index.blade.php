          ...
          <div class="card-body">
            <div class="app-brand justify-content-center">
              <a href="/" class="app-brand-link gap-2">
                <img src="@if(Storage::disk('public')->exists('logo-aplikasi')) {{ asset('storage/' . $app[0]->logo) }} @else {{ asset('assets/img/homepage/logo-sabar.png') }} @endif" class="h-auto bx-tada" style="width: 28px;" alt="Logo-{{ $app[0]->name_app }}"><span class="custom-font text-body fw-bolder text-primary" style="font-size: 1.7rem; cursive; letter-spacing:1px;">{{ $app[0]->name_app }}</span>
              </a>
            </div>
